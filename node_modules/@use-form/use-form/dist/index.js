...
function createForm(args) {
    ...
    return function (hookArgs) {
         ...
         * touched of form.
         **/
        var _a = React__default["default"].useState($store.get()), state = _a[0], setState = _a[1];
        /**
         * Debounce mode is a mode that is used when the form is debounced,
         **/
        var setStateDebounced = React__default["default"].useCallback(debounce(setState, 500), []);
        /**
         ...
         * @param state
         **/
        var persistNextStateDebounced = React__default["default"].useCallback(debounce(persistNextState, 100), []);
        /**
...
function WrapperComponent(_a, ref) {
    ...
    var _c = React__default["default"].useState(null), value = _c[0], setValue = _c[1];
    ...
    return (React__default["default"].createElement(React.Fragment, null,
        React__default["default"].createElement("div", { ref: ref, hidden: true }),
        React__default["default"].createElement(Component, __assign({}, rest, { value: value, selected: (_b = ref.current) === null || _b === void 0 ? void 0 : _b.value, onChange: handleOnChange, onBlur: handleOnBlur }))));
}
var Wrapper = React__default["default"].forwardRef(WrapperComponent);
